<div>
  {{-- Home Section Start --}}
  <div class="w-full h-screen bg-gradient-to-r from-red-400 to-yellow-500 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              Gaya Baru Dimulai dari <span class="text-blue-600">Westside</span>
            </h1>
            <p class="mt-3 text-lg text-gray-700 dark:text-gray-300">
              Pilihan fashion terbaik untuk kamu yang ingin tampil stylish dan percaya diri — dari kaki sampai kepala.
            </p>
          <!-- Buttons -->
          ...
          <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            ...
            <div class="py-5">
              <div class="flex space-x-1">
                <svg class="h-4 w-4 text-black dark:text-black-200" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="h-4 w-4 text-black-800 dark:text-black-200" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M27.0352 1.6307L33.9181 16.3633C34.2173 16.6768 34.5166 16.9903 34.8158 16.9903L50.0779 19.1845C50.9757 19.1845 51.275 20.4383 50.6764 21.0652L39.604 32.3498C39.3047 32.6632 39.3047 32.9767 39.3047 33.2901L41.998 49.2766C42.2973 50.217 41.1002 50.8439 40.5017 50.5304L26.4367 43.3208C26.1375 43.3208 25.8382 43.3208 25.539 43.3208L11.7732 50.8439C10.8754 51.1573 9.97763 50.5304 10.2769 49.59L12.9702 33.6036C12.9702 33.2901 12.9702 32.9767 12.671 32.6632L1.29923 21.0652C0.700724 20.4383 0.999979 19.4979 1.89775 19.4979L17.1598 17.3037C17.459 17.3037 17.7583 16.9903 18.0575 16.6768L24.9404 1.6307C25.539 0.69032 26.736 0.69032 27.0352 1.6307Z" fill="currentColor" />
                </svg>
                <svg class="h-4 w-4 text-black-800 dark:text-black-200" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M27.0352 1.6307L33.9181 16.3633C34.2173 16.6768 34.5166 16.9903 34.8158 16.9903L50.0779 19.1845C50.9757 19.1845 51.275 20.4383 50.6764 21.0652L39.604 32.3498C39.3047 32.6632 39.3047 32.9767 39.3047 33.2901L41.998 49.2766C42.2973 50.217 41.1002 50.8439 40.5017 50.5304L26.4367 43.3208C26.1375 43.3208 25.8382 43.3208 25.539 43.3208L11.7732 50.8439C10.8754 51.1573 9.97763 50.5304 10.2769 49.59L12.9702 33.6036C12.9702 33.2901 12.9702 32.9767 12.671 32.6632L1.29923 21.0652C0.700724 20.4383 0.999979 19.4979 1.89775 19.4979L17.1598 17.3037C17.459 17.3037 17.7583 16.9903 18.0575 16.6768L24.9404 1.6307C25.539 0.69032 26.736 0.69032 27.0352 1.6307Z" fill="currentColor" />
    ...
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-gray-500"> Jelajahi <span class="text-blue-500">Merek
            </span> </h1>
        ...
        <p class="mb-12 text-base text-center text-black mt-5 mb-7">
          Temukan berbagai merek sepatu lari terpopuler yang sudah terpercaya kualitas dan kenyamanannya. Mulai dari pilihan sepatu untuk pelari pemula hingga profesional, dari brand favorit yang mendukung performa dan kenyamanan kamu. Jelajahi dan temukan sepatu lari andalanmu sekarang!        </p>
      </div>
    </div>
    ...
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        ...
        <p class="mb-12 text-base text-center text-white-500">
          Temukan berbagai pilihan sepatu lari terbaik untuk mendukung performa olahragamu! Dari model ringan untuk kecepatan, hingga yang empuk untuk lari jarak jauh—semua dirancang untuk kenyamanan dan daya tahan maksimal. Pilih sepatu lari yang sesuai dengan gaya dan kebutuhanmu!        </p>
      </div>
    </div>
