			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="mb-6">
					...
					<div class="grid grid-cols-2 gap-4">
						<div>
							<label class="block text-   -700 dark:text-white mb-1" for="first_name">
								Nama Depan
							</label>
							<input wire:model='first_name' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('fisrt_name') border-red-500 @enderror" id="first_name" type="text">
							</input>
                            @error('first_name')
		...
		<div class="md:col-span-12 lg:col-span-4 col-span-12">
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="flex justify-between mb-2 font-bold text-white">
					...
					<span>
                        {{ Number::currency(20.000, 'IDR') }}
					</span>
				</div>
				<hr class="bg--400 my-4 h-1 rounded">
				<div class="flex justify-between mb-2 font-bold text-white">
					<span>
						Grand Total
					</span>
